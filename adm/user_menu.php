<?php
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <a href="user_menu.php?ordem=id">Código</a></b></th>
                    <th width="25%"><b>
                    <a href="user_menu.php?ordem=n">Nome</a></b></th>
                    <th width="25%"><b>
                    <a href="user_menu.php?ordem=e">E-mail</a></b></th>
                    <th width="20%"><b>
                    <a href="user_menu.php?ordem=d">Dt. Cad.</a></b></th>
        ...
        while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC))
        {
            $saida .= '<tr>
                ...
                <td class="text-center">
                    <a href="user_alt.php?id=' .
                        $row['id'] . '" 
                        class="btn btn-sm btn-warning">
                        Editar
                    </a>
                    <a href=user_exc.php?id=' .
                        $row['id'] . '" 
    ...
    if ($pagina > 1)
    {
        ...
        if ($pagina_correta != 1)
        {
            ...
            <a class="page-link" href="user_menu.php?s=' .
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="input-group mb-3">
                ...
                placeholder="Pesquise o nome do usuário cadastrado"
                id="busca">
                <div class="input-group-append">
                    <a class="btn btn-primary" 
                        href="#"
                        onclick="this.href='user_menu.php?q='+
